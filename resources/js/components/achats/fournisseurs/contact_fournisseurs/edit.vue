            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-sample" @submit.prevent="editContactFournisseur">
...
export default {
    ...
    mounted(){
        this.$nextTick(function () {
            this.contactFournisseurShow();
        });
    },

    methods: {

        async contactFournisseurShow()
        {
            this.getValues()

            const res   = await this.callApi('post' ,   '/fournisseurs/'+this.$route.params.id_societe_fournisseur+'/contacts/'+this.$route.params.id_contact_fournisseur+'/show'    ,   null)

            this.contact_fournisseur.id_societe_fournisseur           =   res.data.id_societe_fournisseur

            this.contact_fournisseur.nom_contact_fournisseur          =   res.data.nom_contact_fournisseur
            this.contact_fournisseur.prenom_contact_fournisseur       =   res.data.prenom_contact_fournisseur
            this.contact_fournisseur.tel1_contact_fournisseur         =   res.data.tel1_contact_fournisseur
            this.contact_fournisseur.tel2_contact_fournisseur         =   res.data.tel2_contact_fournisseur
            this.contact_fournisseur.email_contact_fournisseur        =   res.data.email_contact_fournisseur
                
            this.contact_fournisseur.adresse_contact_fournisseur      =   res.data.adresse_contact_fournisseur
            this.contact_fournisseur.commune_contact_fournisseur      =   res.data.commune_contact_fournisseur
            this.contact_fournisseur.willaya_contact_fournisseur      =   res.data.willaya_contact_fournisseur
            this.contact_fournisseur.fonction_contact_fournisseur     =   res.data.fonction_contact_fournisseur
        },

        async editContactFournisseur()
        {   
            ...
            const res   = await this.callApi('post' ,   '/fournisseurs/'+this.$route.params.id_societe_fournisseur+'/contacts/'+this.$route.params.id_contact_fournisseur+'/update'    ,   formData)
