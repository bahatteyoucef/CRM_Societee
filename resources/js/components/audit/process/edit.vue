                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col text-center">
                                        <button type="submit" class="btn btn-outline-primary btn-fw" click="editProcess()">Submit</button>
                                    </div>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        ...
        async processShow()
        {
            ...
            const res   = await this.callApi('post' ,   '/process/'+this.$route.params.id+'/show'    ,   null)

            this.process.nom                    =   res.data.nom
            this.process.duree                  =   res.data.duree
            this.process.id_champ_audit         =   res.data.id_champ_audit
            this.process.id_type_process        =   res.data.id_type_process
        },
        ...
        {   
            ...
            const res   = await this.callApi('post' ,   '/process/'+this.$route.params.id+'/update'    ,   formData)
